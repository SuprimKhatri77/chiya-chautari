...
export default function Footer() {
    return (
        <footer className="flex flex-col gap-10 items-center justify-center bg-white w-full py-10 px-3 ">
            <div className="max-w-[1400px]  mx-auto w-full flex flex-col items-center justify-center lg:flex-row lg:justify-evenly flex-wrap lg:items-center">
                <div>
                ...
                <div className="flex flex-col gap-2 text">
                    ...
                    <ul className="flex gap-3 items-center lg:items-start ">
